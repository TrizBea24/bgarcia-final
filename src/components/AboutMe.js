    ...
    <>
      <section id="aboutme" className="about">
        ...
        <p className="about__description">
          Hello! I am Beatriz García, <span>a full stack developer</span>. 
          I invite you to check my projects bellow. They are made with <span>HTML, CSS, Sass, Tailwind, Bootstrap, JavaScript, React, Python and SQLite.</span><br /> 
          <br />
